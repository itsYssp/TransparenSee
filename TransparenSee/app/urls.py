...
urlpatterns = [
    ...
    path('officer-profile/', OfficerProfileView.as_view(), name='officer_profile'),
    ...
    path('officer/accomplishment-report/', AccomplishmentReportView.as_view(), name='accomplishment_report'),
