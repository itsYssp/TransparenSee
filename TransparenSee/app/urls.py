...
urlpatterns = [
    ...
    path('treasurer/society-fee/bulk-preview/', BulkFeePreviewView.as_view(), name='bulk_fee_preview'),
    path('treasurer/society-fee-preview/', SocietyFeePreviewView.as_view(), name='society_fee_preview'),
    path('treasurer/reports/voluntary-members/', VoluntaryFundsMembersView.as_view(), name='voluntary_members'),
    ...
    path("campus-admin/update-head/<int:pk>/", UpdateHeadView.as_view(), name="campus_admin_update_head"),
    ...
    path('head/update-officer/<int:pk>/', UpdateOfficerView.as_view(), name='head_update_officer'),
